...
// use egui::unicode_segmentation::UnicodeSegmentation as _;
use epaint::text::{Galley, cursor::CCursor};

use egui::{NumExt as _, Rect, Response, Ui, epaint};

use crate::code::cursor_range::CCursorRange;
...
#[cfg(test)]
mod test {
    use crate::code::text_cursor_state::next_word_boundary_char_index;
