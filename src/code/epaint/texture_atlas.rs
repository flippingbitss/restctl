use egui::emath::{Rect, remap_clamp};
use egui::epaint::ecolor::Color32;

use egui::epaint::{AlphaFromCoverage, ColorImage, ImageDelta};
...
impl TextureAtlas {
        ...
        self.discs
            ...
            .map(|disc| {
                ...
                let uv = Rect::from_min_max(
                    egui::emath::pos2(min_x as f32 * inv_w, min_y as f32 * inv_h),
                    egui::emath::pos2(max_x as f32 * inv_w, max_y as f32 * inv_h),
                );
    ...
    #[inline]
    pub fn texture_options() -> egui::epaint::textures::TextureOptions {
